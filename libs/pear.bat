...
FOR %%x IN ("C:\Apache2\htdocs\tshirtshop\libs\pear") DO (if %%x=="%PMTPMTPMT%" GOTO :NOTINSTALLED)

REM Check PEAR global ENV, set them if they do not exist
IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=C:\Apache2\htdocs\tshirtshop\libs\pear"
IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=C:\Apache2\htdocs\tshirtshop\libs"
IF "%PHP_PEAR_PHP_BIN%"=="" SET "PHP_PEAR_PHP_BIN=C:\Apache2\modules\php\.\php.exe"
GOTO :INSTALLED
